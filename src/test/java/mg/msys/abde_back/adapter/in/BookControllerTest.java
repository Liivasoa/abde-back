...
class BookControllerTest {
    ...
    void testSearchBooksWithAllFilters() throws Exception {
        ...
        mockMvc.perform(get("/api/book/search")
                ...
                .andExpect(jsonPath("$.items[0].authors[0]").value("Herman Melville"))
    ...
    void testSearchBooksWithoutFilters() throws Exception {
        when(searchBooksUseCase.execute(null, null, null, null, 0, 20))
                .thenReturn(PaginatedResult.of(
                        List.of(
                                new Book(1L, "Moby Dick", LocalDate.of(1851, 1, 1), "EN", List.of("Herman Melville")),
                                new Book(3L, "Le Petit Prince", LocalDate.of(1932, 1, 1), "FR",
                                        List.of("Antoine de Saint-Exupery"))),
                        0,
                        20,
                        2));
